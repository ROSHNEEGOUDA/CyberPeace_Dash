...
const EditCourse = () => {
  ...
  const getLevelClasses = (level) => {
    switch (level) {
      case "Beginner":
        return "bg-green-500 text-white px-4 py-1 rounded";
      case "Medium":
        return "bg-yellow-500 text-white px-4 py-1 rounded";
      case "Advanced":
        return "bg-red-500 text-white px-4 py-1 rounded";
      default:
        return "bg-gray-500 text-white px-4 py-1 rounded";
    }
  };

  return (
    <div className="max-w-5xl p-6 bg-gray-100 relative">
      {successMessage && (
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          ...
          <select
            ...
            className={`w-full p-2 border border-gray-300 rounded ${getLevelClasses(level)}`}
          >
