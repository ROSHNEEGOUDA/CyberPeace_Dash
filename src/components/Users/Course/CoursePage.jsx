...
import { faStar, faUser,faBell,faSearch, faUsers, faFileAlt, faVideo, faClock, faTools, faDesktop, faShieldAlt, faShieldVirus, faNetworkWired, faKey } from '@fortawesome/free-solid-svg-icons';
        ...
        <div className="max-w-7xl mx-auto p-6 bg-gray-100">
            ...
            <div className="flex flex-col gap-2 md:flex-row justify-between h-full">
                <div className='w-2/3'>
                        ...
                        <div className="md:flex-1">
                            <div className="flex items-center space-x-2 mb-2">
                                <div className=' space-x-2 py-1 px-2 bg-yellow-300 rounded-3xl text-sm'>
                                    ...
                                    <a href="#" className="text-yellow-500">4.6</a>
                                </div>
                    ...
                    <div className="mt-6 bg-white p-6 w-full rounded-lg shadow-md">
                        ...
                        <div className="space-y-4">
                            <WeekContent weekTitle="Week 1 - Introduction" content={week1Content} />
                            <WeekContent weekTitle="Week 2 - Malware" content={week2Content} />
                            <WeekContent weekTitle="Week 3 - Penetration Testing" content={week3Content} />
                        </div>
                    </div>
                </div>
                <div className="mt-6 md:mt-0 md:ml-6 bg-white p-6 w-5/6 md:w-1/3 rounded-lg shadow-md">
                    ...
                    {isEnrolled ? (
                        <>
                            <Link to="/course/coursePage/coursePreview"><button className="w-full bg-blue-500 text-white py-2 rounded mt-4">Preview</button></Link>
                            <div className="mt-4 text-green-600 text-center font-semibold">Enrolled Successfully</div>
                        </>
                    ) : (
                        <button onClick={handleEnroll} className="w-full bg-blue-500 text-white py-2 rounded mt-4">Enroll Now</button>
                    )}
                    <div className="mt-4">
                        <h2 className="text-xl font-semibold text-gray-800">This course includes</h2>
                        <div className="space-y-2 text-gray-600 mt-2">
                            <div><FontAwesomeIcon icon={faShieldAlt} className='mr-3' />Cybersecurity Fundamentals</div>
                            <div><FontAwesomeIcon icon={faShieldVirus} className='mr-3' />Malware Types</div>
                            <div><FontAwesomeIcon icon={faNetworkWired} className='mr-3' />Network Security Basics</div>
                            <div><FontAwesomeIcon icon={faKey} className='mr-3' />Authentication & Authorization</div>
                        </div>
                    </div>
                </div>
            </div>
