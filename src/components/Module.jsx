  ...
  return (
    <div className="flex flex-col relative" style={{ width: "100%", height: "100vh", backgroundImage: `url(${sprinkleSvg})`, backgroundSize: 'cover', backgroundPosition: 'center', zIndex: 0 }}>
      ...
      <div className="absolute top-10 right-6 z-10">
        ...
        {/* Dropdown */}
        {showDropdown && (
          <div className="absolute top-12 right-6 bg-white shadow-md py-2 px-14 rounded-md z-20">
      ...
      {/* Discussion Form */}
      {showDiscussionForm && (
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white shadow-md p-6 rounded-md z-20 border-black mt-8" style={{ width: "600px" }}>
